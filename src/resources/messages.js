const messages = {
  ...
  explorerToolDescription: { id: 'app.explorer.description', defaultMessage: 'Use Explorer to create an instant analysis of how digital news media covers your topic of interest. You can see attention paid to the issue, language used, and people and places mentioned.' },
  ...
  privacyPolicy: { id: 'privacyPolicy.name', defaultMessage: 'Privacy Policy', url: 'https://docs.google.com/document/d/1eEQ4WcxaSueSEJMxrbsayh-GN8_XW1D0a3C9Ye26a7I/edit?usp=sharing' },
  terms: { id: 'terms.name', defaultMessage: 'Terms of  Service', url: 'https://docs.google.com/document/d/18J1NGi5dAk5Z2sD4l8Qg71lB_MxWqKhNMHni7eonbI0/edit#heading=h.f0qrdh998i1o' },
  join: { id: 'join.name', defaultMessage: 'Join Our Community', url: 'https://docs.google.com/spreadsheets/d/11R4drj1z1kBfTc9z8mw99HaqQivQcuo37pjWWdjfNPM/edit?usp=sharing)'},
