const messages = {
  ...
  primaryLanguage: { id: 'source.primaryLanguage', defaultMessage: 'Detected Primary Language' },
  countryOfFocus: { id: 'source.countryOfFocus', defaultMessage: 'Detected Subject Country' },
